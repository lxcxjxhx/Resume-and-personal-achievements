...
```mermaid
mindmap
  root((Comprehensive Competency Map))
    Technical Core
      Python Programming
        Data Analysis
        AI Model Building
    ...
    Professional Domains
      Cybersecurity
        ...
        CTF Practice
        Platform Building (Heart of Steel)
      Artificial Intelligence
        Machine Learning
        Deep Learning
        NLP Processing
        Project Application (HOS-ALL)
      Healthcare AI Exploration
        Dialogue Systems
        Data Analysis
        Model Training (Non-medical Professional)
    Comprehensive Literacy
      ...
      Sports & Science Popularization
        ...
        Exhibition & Performance Activities
